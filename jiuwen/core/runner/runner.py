...
from jiuwen.core.rails import RailPipeline
...
class Runner:
    ...
    async def run_agent(
        ...
        """Execute an agent through the rail pipeline.
        ...
        Returns:
            Dict with agent results (possibly filtered by rails).
        """
        return await cls.rails.run(agent, inputs, session=session)
